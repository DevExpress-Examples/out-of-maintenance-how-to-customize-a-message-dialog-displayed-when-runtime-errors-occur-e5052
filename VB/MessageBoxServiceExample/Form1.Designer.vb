...
Namespace MessageBoxServiceExample
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			' barButtonItem1
			' 
			Me.barButtonItem1.Caption = "Click Me!"
